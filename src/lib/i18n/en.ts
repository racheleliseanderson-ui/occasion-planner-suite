...
export const en = {
  ...
  "arch.scenarios.body": "Load a situation and Architecture builds immediately — then change a single input to see what it costs you.",
  ...
  "arch.field.seatsUnknown": "Unknown — Plan will ask",
  ...
  "arch.action.apply": "Review handoff to Plan",
  ...
  "arch.review.title": "What moves to Plan",
  ...
  "arch.review.confirm": "Apply this architecture",
  "arch.review.cancel": "Keep editing",
  "arch.apply.stashed": "Architecture handed to Plan. The selected menu travels with it.",
  ...
  "arch.status.ready": "Architecture ready. Review roles, stress, and the service plan, then apply to Plan when clean.",
  "arch.status.loadedProposal": "Shared proposal loaded into the form.",
  "arch.result.eyebrow": "Result",
  "arch.result.title": "Architecture, stress, service, packet",
