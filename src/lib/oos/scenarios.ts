...
export const SCENARIOS: Scenario[] = [
  ...
  {
    id: "vongole-muscadet-eight",
    label: "Vongole & Muscadet table",
    note: "Seated · clams · acid and brine · leftover liquor",
    family: "Table",
    patch: { label: "Vongole & Muscadet", shape: "dinner", style: "seated", guests: 8, helpers: 1, prepWindowH: 3, ambition: 2, diets: [], season: "summer", budgetTier: 2, kids: false, outdoor: false, leftovers: "some", serviceTime: "19:30", kitchen: k({ seats: 8 }), ops: o({ table: { tables: 1, seatsPerTable: 8, courses: 3, serviceMode: "family", tablesideFinishing: false }, general: { skill: 2, alcohol: true, serviceDurationMin: 150, cleanupWindowMin: 60, dietStrictness: "preference" } }) },
  },
  {
    id: "burrata-rose-summer",
    label: "Burrata, tomato & dry rosé",
    note: "Peak summer · almost no heat · season fit",
    family: "Table",
    patch: { label: "Burrata and rosé", shape: "dinner", style: "seated", guests: 6, helpers: 0, prepWindowH: 2, ambition: 1, diets: ["no-meat"], season: "summer", budgetTier: 2, kids: false, outdoor: true, leftovers: "some", serviceTime: "19:00", kitchen: k({ ovens: 0, burners: 1, seats: 6, counter: "small" }), ops: o({ table: { tables: 1, seatsPerTable: 6, courses: 2, serviceMode: "family", tablesideFinishing: false }, general: { skill: 1, alcohol: true, serviceDurationMin: 120, cleanupWindowMin: 45, dietStrictness: "preference" } }) },
  },
  {
    id: "sausage-gamay-six",
    label: "Sausage, peppers & Gamay",
    note: "One pan · light red · leftover bread",
    family: "Table",
    patch: { label: "Sausage and Gamay", shape: "dinner", style: "seated", guests: 6, helpers: 0, prepWindowH: 2, ambition: 1, diets: [], season: "autumn", budgetTier: 1, kids: false, outdoor: false, leftovers: "some", serviceTime: "19:30", kitchen: k({ ovens: 0, burners: 2, seats: 6, counter: "small" }), ops: o({ constraint: { sink: "single", prepSurfaces: 1, singleBurnerMode: false, noOvenMode: true, coldBoxes: 0, powerLimited: false, curfew: false, shoppingTrips: 1, pantryOnly: false, hardCapPerHead: null } }) },
  },
  {
    id: "scallops-chablis-four",
    label: "Scallops, brown butter & Chablis",
    note: "Plated · short window · acid cuts richness",
    family: "Table",
    patch: { label: "Scallops and Chablis", shape: "dinner", style: "seated", guests: 4, helpers: 0, prepWindowH: 2, ambition: 2, diets: ["no-meat"], season: "winter", budgetTier: 3, kids: false, outdoor: false, leftovers: "none", serviceTime: "20:00", kitchen: k({ seats: 4 }), ops: o({ table: { tables: 1, seatsPerTable: 4, courses: 3, serviceMode: "plated", tablesideFinishing: true }, general: { skill: 2, alcohol: true, serviceDurationMin: 120, cleanupWindowMin: 45, dietStrictness: "preference" } }) },
  },
  {
    id: "pork-cider-eight",
    label: "Roast pork loin & cider",
    note: "Herb pork · dry cider · deliberate leftovers",
    family: "Table",
    patch: { label: "Pork and cider", shape: "dinner", style: "seated", guests: 8, helpers: 1, prepWindowH: 5, ambition: 2, diets: [], season: "autumn", budgetTier: 2, kids: false, outdoor: false, leftovers: "deliberate", serviceTime: "19:00", kitchen: k({ seats: 8 }) },
  },
  {
    id: "panzanella-rose-ten",
    label: "Panzanella & dry rosé",
    note: "Peak tomatoes · almost no heat · leftover bread salad",
    family: "Table",
    patch: { label: "Panzanella and rosé", shape: "dinner", style: "seated", guests: 10, helpers: 1, prepWindowH: 2, ambition: 1, diets: ["no-meat"], season: "summer", budgetTier: 2, kids: false, outdoor: true, leftovers: "some", serviceTime: "19:00", kitchen: k({ ovens: 0, seats: 10 }) },
  },
  {
    id: "zero-proof-bitter-orange",
    label: "Zero-proof bitter-orange table",
    note: "Equal-status pour · no alcohol · full table",
    family: "Table",
    patch: { label: "Bitter-orange table", shape: "dinner", style: "seated", guests: 8, helpers: 1, prepWindowH: 4, ambition: 2, diets: ["no-alcohol"], season: "summer", budgetTier: 2, kids: false, outdoor: false, leftovers: "some", serviceTime: "19:00", kitchen: k({ seats: 8 }), ops: o({ general: { skill: 2, alcohol: false, serviceDurationMin: 150, cleanupWindowMin: 60, dietStrictness: "preference" } }) },
  },
  {
    id: "two-burner-pairing-supper",
    label: "Two-burner pairing supper",
    note: "No oven · one pot + one skillet · honest small kitchen",
    family: "Constrained",
    patch: { label: "Two-burner supper", shape: "dinner", style: "seated", guests: 4, helpers: 0, prepWindowH: 2, ambition: 1, diets: [], season: "year-round", budgetTier: 1, kids: false, outdoor: false, leftovers: "some", serviceTime: "19:30", kitchen: k({ ovens: 0, burners: 2, dishwasher: false, fridge: "tight", counter: "small", seats: 4 }), ops: o({ constraint: { sink: "scarce", prepSurfaces: 1, singleBurnerMode: false, noOvenMode: true, coldBoxes: 0, powerLimited: false, curfew: false, shoppingTrips: 1, pantryOnly: false, hardCapPerHead: null } }) },
  },
  {
    id: "hanger-syrah-six",
    label: "Hanger steak & cool-climate Syrah",
    note: "Seated six · pepper and acid against beef · leftover sandwiches",
    family: "Table",
    patch: { label: "Hanger and Syrah", shape: "dinner", style: "seated", guests: 6, helpers: 0, prepWindowH: 2, ambition: 2, diets: [], season: "autumn", budgetTier: 2, kids: false, outdoor: false, leftovers: "some", serviceTime: "20:00", kitchen: k({ seats: 6, burners: 2 }) },
  },
];
