  ...
  head: () => ({
    meta: [
      { title: "Library workshop — tune the dishes and kitchen you actually have" },
      {
        name: "description",
        content:
          "Edit or hide fixture dishes, add your own, save kitchen equipment profiles, and keep the whole configuration on this device — or export it as one portable config file. Import merges; the newer edit wins.",
      },
      ...
      <section className="relative isolate overflow-hidden border-b border-border bg-ink text-ink-foreground">
        ...
        <div className="relative mx-auto max-w-6xl px-5 py-14">
          ...
          <p className="mt-5 max-w-2xl text-sm leading-relaxed text-ink-muted">
            ...
            stays in this browser and travels as one config file you own. Import merges
